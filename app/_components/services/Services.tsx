    ...
    <div className="mt-[11vh] md:h-[90vh] flex items-center" id="services">
      <div className="container px-5 md:px-0">
        <div className="text-center mb-10 md:mb-24">
          <p className="uppercase text-sm font-bold text-[#009990] md:text-lg">Services</p>
        ...
        <div className='flex flex-col gap-10 md:grid grid-cols-2 lg:grid-cols-3'>
          {
            serviceData.map(item=>(
              <div key={item.id} className='text-center p-5 rounded-lg shadow-md'>
                <span className='text-6xl text-[#009990] w-full text-center service-box'>{item.icon}</span>
